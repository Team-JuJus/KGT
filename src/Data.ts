...
export const MOCK_PRODUCTS = [
  {
    title_en: "ZEISS Axio Imager 2 Microscope",
    title_fa: "میکروسکوپ زایس مدل Axio Imager 2",
    link: "https://www.zeiss.com/microscopy/en/products/light-microscopes/axio-imager-2.html",
    alt: "ZEISS Axio Imager 2 research microscope",
    image: "/microscope.jpg",
    summary_en:
      "The ZEISS Axio Imager 2 is a high-performance research microscope designed for advanced imaging in life and material sciences. It offers exceptional image clarity, motorized components, and reliable reproducibility.",
    summary_fa:
      "میکروسکوپ تحقیقاتی زایس مدل Axio Imager 2 یک دستگاه پیشرفته برای تصویربرداری در علوم زیستی و مواد است که وضوح تصویر بالا، اجزای موتوردار و تکرارپذیری دقیق را فراهم می‌کند.",
    category_en: "Device",
    category_fa: "دستگاه",
    company: "Zeiss",
    country_en: "Germany",
